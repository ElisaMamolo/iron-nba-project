...
const app       = express();
const path      = require("path"); //same as this ("views", path.join(__dirname, "views"));
...
//Partials are templates we can create and reuse calling them from different parts 
//of our application.
...
/* if i want to render layout
app.get("/teams", (req, res, next) => res.render("teams"));
 */
//if i don't want to render the layout
